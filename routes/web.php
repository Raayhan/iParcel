...
Route::group(['middleware' => 'prevent-back-history'],function(){
  ...
  Route::prefix('/customer')->name('customer.')->namespace('Customer')->group(function(){
      ...
      Route::get('/parcel/confirm',[App\Http\Controllers\Customer\Parcel\RequestController::class,'MakePayment'])->middleware('customer')->name('Payment');
      ...
      Route::post('/parcel/confirm',[App\Http\Controllers\Customer\Parcel\RequestController::class,'MakeRequest']);
