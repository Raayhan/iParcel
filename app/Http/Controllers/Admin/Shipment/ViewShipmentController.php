...
class ViewShipmentController extends Controller
{
    public function ShowPage(){
        $shipments = DB::table('shipments')->select('id','parcel_id','recipient_name','recipient_phone','recipient_address','zone','notes','created_at','type','delivery','details','status','amount')->get();
